...
extern void NAME(unsigned char *rgb, uint16_t len) __attribute__((noinline)); \
void NAME(unsigned char *rgb, uint16_t len) { WS2811_OUT_1(PORT, PIN, rgb, len); }

#define DEFINE_WS2811_OUT_2_FN(NAME, PORT0, PIN0, PORT1, PIN1) \
extern void NAME(unsigned char *rgb0, unsigned char *rgb1, uint16_t len) \
    __attribute__((noinline)); \
void NAME(unsigned char *rgb0, unsigned char *rgb1, uint16_t len) { \
    WS2811_OUT_2(PORT0, PIN0, rgb0, PORT1, PIN1, rgb1, len); \
}

#define DEFINE_WS2811_OUT_3_COMMON_FN(NAME, PORT, PIN0, PIN1, PIN2) \
extern void NAME(unsigned char *rgb0, unsigned char *rgb1, unsigned char *rgb2, \
        uint16_t len) __attribute__((noinline)); \
void NAME(unsigned char *rgb0, unsigned char *rgb1, unsigned char *rgb2, \
        uint16_t len) { \
...
extern void NAME(unsigned char *rgb0, unsigned char *rgb1, unsigned char *rgb2, \
        unsigned char *rgb3, uint16_t len) __attribute__((noinline)); \
void NAME(unsigned char *rgb0, unsigned char *rgb1, unsigned char *rgb2, \
        unsigned char *rgb3, uint16_t len) { \
